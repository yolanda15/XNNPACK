    ...
    const union xnn_qs8_gemm_params params[restrict XNN_MIN_ELEMENTS(1)]) XNN_DISABLE_TSAN
{
  ...
  do {
    ...
    int32x4_t vacc0x8 = vld1q_s32(w); w = (const void*) ((uintptr_t) w + 4 * sizeof(int32_t));
    int32x4_t vacc0x9 = vld1q_s32(w); w = (const void*) ((uintptr_t) w + 4 * sizeof(int32_t));
    int32x4_t vacc0x10 = vld1q_s32(w); w = (const void*) ((uintptr_t) w + 4 * sizeof(int32_t));
    int32x4_t vacc0x11 = vld1q_s32(w); w = (const void*) ((uintptr_t) w + 4 * sizeof(int32_t));
    int32x4_t vacc0x12 = vld1q_s32(w); w = (const void*) ((uintptr_t) w + 4 * sizeof(int32_t));
    int32x4_t vacc0x13 = vld1q_s32(w); w = (const void*) ((uintptr_t) w + 4 * sizeof(int32_t));
    int32x4_t vacc0x14 = vld1q_s32(w); w = (const void*) ((uintptr_t) w + 4 * sizeof(int32_t));
    int32x4_t vacc0x15 = vld1q_s32(w); w = (const void*) ((uintptr_t) w + 4 * sizeof(int32_t));
    ...
    int32x4_t vacc0x89AB = combine4(vacc0x8, vacc0x9, vacc0x10, vacc0x11);
    int32x4_t vacc0xCDEF = combine4(vacc0x12, vacc0x13, vacc0x14, vacc0x15);
    ...
    int32x4_t vacc1x89AB = combine4(vacc1x8, vacc1x9, vacc1x10, vacc1x11);
    int32x4_t vacc1xCDEF = combine4(vacc1x12, vacc1x13, vacc1x14, vacc1x15);
    ...
    int32x4_t vacc2x89AB = combine4(vacc2x8, vacc2x9, vacc2x10, vacc2x11);
    int32x4_t vacc2xCDEF = combine4(vacc2x12, vacc2x13, vacc2x14, vacc2x15);
    ...
    int32x4_t vacc3x89AB = combine4(vacc3x8, vacc3x9, vacc3x10, vacc3x11);
    int32x4_t vacc3xCDEF = combine4(vacc3x12, vacc3x13, vacc3x14, vacc3x15);
    ...
    const int16x8_t vacc0x89ABCDEF = vqaddq_s16(vqmovn_high_s32(vqmovn_s32(vacc0x89AB), vacc0x9), voutput_zero_point);
    const int16x8_t vacc1x01234567 = vqaddq_s16(vqmovn_high_s32(vqmovn_s32(vacc1x0123), vacc1x1), voutput_zero_point);
    const int16x8_t vacc1x89ABCDEF = vqaddq_s16(vqmovn_high_s32(vqmovn_s32(vacc1x89AB), vacc1x9), voutput_zero_point);
    const int16x8_t vacc2x01234567 = vqaddq_s16(vqmovn_high_s32(vqmovn_s32(vacc2x0123), vacc2x1), voutput_zero_point);
    const int16x8_t vacc2x89ABCDEF = vqaddq_s16(vqmovn_high_s32(vqmovn_s32(vacc2x89AB), vacc2x9), voutput_zero_point);
    const int16x8_t vacc3x01234567 = vqaddq_s16(vqmovn_high_s32(vqmovn_s32(vacc3x0123), vacc3x1), voutput_zero_point);
    const int16x8_t vacc3x89ABCDEF = vqaddq_s16(vqmovn_high_s32(vqmovn_s32(vacc3x89AB), vacc3x9), voutput_zero_point);
